...
while(contin=='y'):
    ...
    d = call_playlist("spotify",playlist_id)
...
a.to_excel("C:/Users/bhave/OneDrive/Desktop/spot project/Add_Songs.xlsx") #use different path/directory according to your computer
print("Done")
